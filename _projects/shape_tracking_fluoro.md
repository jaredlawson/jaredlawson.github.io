...
<div class="caption">
    The radiopaque marker band of an off-the-shelf catheter. From {% cite lawson2025shapesense %}.
</div>
...
<div class="caption">
    The radiopaque marker bands placed patterned around a radiolucent catheter. From {% cite lawson2025shapesense %}.
</div>
...
<div class="caption">
    Workflow of shape estimation for the slim catheter prototype. From {% cite lawson2025shapesense %}.
</div>
...
<div class="caption">
    Estimated shape overlaid on fluoroscopic images. From {% cite lawson2025shapesense %}.
</div>
